...
const COUNTRIES = [
  ...
  { name: "Сербия", code: "RS", continent: "Европа", status: "признана", ready: true, free: { line: "🟡 Реальный путь к паспорту ЕС-кандидата, но с важной оговоркой", visa: "Безвизово для россиян", dual: "Придётся официально отказаться от гражданства РФ — Сербия двойное гражданство не признаёт (кроме этнических сербов и особых случаев)" }, paid: {
    vnj: { title: "ВНЖ", points: [
      "Через открытие фирмы (ИП/ООО) — без формально установленного минимума инвестиций, но нужно показать реальную деятельность",
      "Через покупку недвижимости (обычно ориентируются на актив от €250 000, юридически жёсткого порога нет)",
    ...
    grazhdanstvo: { title: "Гражданство", points: [
      ...
      "Обязательное условие для большинства заявителей — отказ от предыдущего гражданства (Сербия не признаёт двойное, кроме этнических сербов)",
      "Именно этот пункт нужно показывать пользователю особенно заметно — многие узнают о нём слишком поздно",
    ]},
  ...
  { name: "Турция", code: "TR", continent: "Европа/Азия", status: "признана", ready: true, free: { line: "🟢 Один из самых доступных вариантов легализации для россиян", visa: "Безвизово до 60 дней за один заезд, не более 90 дней за 180 дней", dual: "Двойное гражданство с Россией допускается" }, paid: {
    vnj: { title: "ВНЖ (икамет)", points: [
      ...
      "Покупка недвижимости даёт право на ВНЖ без минимальной суммы (но от $400 000 — путь к гражданству, см. ниже)",
      "Оформляется на 1-2 года с продлением, пошлина + карта + страховка — примерно $50-100/год",
      "Нужно встать на учёт в миграционной службе (göç idaresi) в течение месяца после въезда",
    ]},
    pmj: { title: "ПМЖ", points: [
      "После 8 лет непрерывного законного проживания по ВНЖ",
      "Требуется отсутствие длительных выездов из страны и нарушений закона",
    ]},
    grazhdanstvo: { title: "Гражданство", points: [
      "Стандартный путь: от 5 лет проживания по ВНЖ + знание турецкого языка на базовом уровне",
      "Быстрый путь — гражданство за инвестиции: покупка недвижимости от $400 000 (держать не менее 3 лет) или банковский депозит от $500 000, или создание 50+ рабочих мест",
      "Сумма порога может меняться — сверяться с официальным сайтом перед сделкой",
    ]},
  ...
  { name: "Армения", code: "AM", continent: "Азия", status: "признана", ready: true, free: { line: "🟢 Самый гладкий путь к паспорту среди популярных направлений", visa: "Безвизово до 180 дней в году", dual: "Двойное гражданство разрешено — отказываться от российского не нужно" }, paid: {
    vnj: { title: "ВНЖ", points: [
      "Основания: бизнес (ИП/учредитель компании), работа по контракту, учёба, брак с гражданином Армении",
      "Минимальной суммы инвестиций не требуется — в отличие от большинства других стран пятёрки",
      "Выдаётся на 1 год с продлением",
    ]},
    pmj: { title: "ПМЖ", points: [
      "Оформляется после нескольких лет проживания по ВНЖ (обычно от 3 лет непрерывного проживания)",
    ]},
    grazhdanstvo: { title: "Гражданство", points: [
      "Натурализация: от 3 лет непрерывного проживания в статусе ВНЖ/ПМЖ + владение армянским языком на базовом уровне",
      "Для этнических армян — упрощённая программа репатриации, без стандартного срока ожидания",
      "⚠️ Встречаются агентства, обещающие \"гражданство за 4-6 месяцев без ВНЖ\" — это касается узких случаев (этническое происхождение/особые решения), не рядового заявителя",
    ]},
  ...
  { name: "Грузия", code: "GE", continent: "Азия", status: "признана", ready: true, free: { line: "🟡 Доступно, но путь к паспорту самый долгий из популярных направлений", visa: "Безвизово до 365 дней", dual: "Двойное гражданство не предусмотрено (кроме репатриантов/инвесторов по решению властей)" }, paid: {
    vnj: { title: "ВНЖ", points: [
      "Основания: инвестиции в недвижимость/бизнес (от $100 000), трудоустройство, учёба",
    ...
    pmj: { title: "Постоянный вид на жительство", points: [
      ...
      "Отдельная категория от гражданства, даёт больше прав, но не паспорт",
    ]},
    grazhdanstvo: { title: "Гражданство", points: [
      ...
      "Двойное гражданство по умолчанию не допускается — нужно отказаться от российского (кроме решений президента для инвесторов/особых заслуг)",
    ]},
  ...
  { name: "ОАЭ", code: "AE", continent: "Азия", status: "признана", ready: true, free: { line: "🟡 ВНЖ получить легко, но гражданство почти недостижимо", visa: "Для россиян ставится бесплатно при въезде", dual: "Гражданство ОАЭ практически не выдаётся резидентам — точечные случаи по приглашению, не открытая программа" }, paid: {
    vnj: { title: "ВНЖ", points: [
      "«Золотая виза»: покупка недвижимости от 2 млн AED (~$545 000), выдаётся на 5-10 лет с продлением",
      "Виза для фрилансеров/удалённых сотрудников — без покупки недвижимости, обычно на 1 год",
      "Рабочая виза через работодателя-спонсора — 2-3 года",
    ...
    pmj: { title: "Постоянного ПМЖ как отдельной категории нет", points: [
      "Роль ПМЖ фактически выполняет продлеваемая «золотая виза» на 10 лет",
    ]},
    grazhdanstvo: { title: "Гражданство", points: [
      "Открытой программы для рядовых резидентов нет",
      "С 2021 года есть закон о гражданстве по приглашению для отдельных инвесторов, учёных, врачей, деятелей культуры — решение принимается точечно правителем эмирата, заявку подать самостоятельно нельзя",
      "Вывод: если цель — именно паспорт, ОАЭ не подходит; если цель — образ жизни и бизнес-климат, ОАЭ один из лучших вариантов",
    ]},
        ...
        >
          <div onClick={(e) => e.stopPropagation()} style={{ background: "#FFFDF8", borderRadius: 16, maxWidth: 420, width: "100%", padding: 24, position: "relative" }}>
            ...
            {devUnlocked && activeCountry.ready && activeCountry.paid ? (
              <div>
                <div style={{ fontWeight: 700, fontSize: 13.5, marginBottom: 6, color: "#16233F" }}>
                  {activeCountry.paid.vnj.title}
                </div>
                <ul style={{ fontSize: 12.5, color: "#3D3A30", lineHeight: 1.6, paddingLeft: 18, marginTop: 0, marginBottom: 14 }}>
                  {activeCountry.paid.vnj.points.map((p, i) => (
                    <li key={i}>{p}</li>
                  ))}
                </ul>
                <div style={{ fontWeight: 700, fontSize: 13.5, marginBottom: 6, color: "#16233F" }}>
                  {activeCountry.paid.pmj.title}
                </div>
                <ul style={{ fontSize: 12.5, color: "#3D3A30", lineHeight: 1.6, paddingLeft: 18, marginTop: 0, marginBottom: 14 }}>
                  {activeCountry.paid.pmj.points.map((p, i) => (
                    <li key={i}>{p}</li>
                  ))}
                </ul>
                <div style={{ fontWeight: 700, fontSize: 13.5, marginBottom: 6, color: "#16233F" }}>
                  {activeCountry.paid.grazhdanstvo.title}
                </div>
                <ul style={{ fontSize: 12.5, color: "#3D3A30", lineHeight: 1.6, paddingLeft: 18, marginTop: 0, marginBottom: 14 }}>
                  {activeCountry.paid.grazhdanstvo.points.map((p, i) => (
                    <li key={i}>{p}</li>
                  ))}
                </ul>
                <div style={{ background: "#F6F1E4", borderRadius: 10, padding: "10px 14px", fontSize: 12, color: "#5C574A" }}>
                  <span style={{ fontWeight: 600 }}>Юристы: </span>
